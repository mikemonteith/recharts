...
import { getBandSizeOfAxis, getAnyElementOfObject, getValueByDataKey, findPositionOfBar } from '../util/DataUtils';
...
var getComposedData = function getComposedData(_ref3) {
  ...
  return data.map(function (entry, index) {
    var value = stackedData ? stackedData[dataStartIndex + index] : [baseValue, getValueByDataKey(entry, dataKey)];
    var x = void 0,
        y = void 0,
        width = void 0,
        height = void 0;
