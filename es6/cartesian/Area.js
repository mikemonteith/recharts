...
var Area = pureRender(_class = (_temp2 = _class2 = function (_Component) {
  ...
  function Area() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Area.__proto__ || Object.getPrototypeOf(Area)).call.apply(_ref, [this].concat(args))), _this), _this.state = { isAnimationFinished: true }, _this.id = _uniqueId('recharts-area-'), _this.handleAnimationEnd = function () {
  ...
  _createClass(Area, [{
    ...
    value: function renderCurve() {
      ...
      return React.createElement(
        'g',
        null,
        curve && React.createElement(Curve, _extends({}, getPresentationAttributes(this.props), {
