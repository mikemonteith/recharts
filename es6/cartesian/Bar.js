...
var Bar = pureRender(_class = (_temp2 = _class2 = function (_Component) {
  ...
  function Bar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Bar.__proto__ || Object.getPrototypeOf(Bar)).call.apply(_ref, [this].concat(args))), _this), _this.state = { isAnimationFinished: false }, _this.id = _uniqueId('recharts-bar-'), _this.handleAnimationEnd = function () {
